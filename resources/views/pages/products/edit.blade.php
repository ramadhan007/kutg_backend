...
<div class="form-group">
<label for="type" class="form-control-label">Nama Barang</label>
...
<textarea  name="description" value="" class="ckeditor form-control @error('description') is-invalid @enderror">
